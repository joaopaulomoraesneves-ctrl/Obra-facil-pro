  ...
  renderReport(){
    ...
    $("reportDocument").innerHTML=`
      ...
      <div class="reportGrid">
        ...
        <div class="reportBox">
          <h3>5.1 Campo, medições e alterações</h3>
          <table class="reportTable">
            <tr><th>Indicador</th><th>Resultado</th></tr>
            <tr><td>Documentos/fotos registrados</td><td>${fieldSummary.documents}</td></tr>
            <tr><td>Medições registradas</td><td>${fieldSummary.measurements}</td></tr>
            <tr><td>Valor executado medido</td><td>${money(fieldSummary.measuredValue)}</td></tr>
